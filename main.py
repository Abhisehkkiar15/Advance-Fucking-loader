...
OWNER_ID = 7834875502 # Replace with the actual owner's user ID
...
async def upload(bot: Client, m: Message):
    ...
    try:
        ...
        # Check if the response status is OK
            ...
            # Remove the PDF file after sending
                ...
                await m.reply_text(f'‼️L LAG GYE GURU‼️\n\n'
                                   f'📝𝗡𝗮𝗺𝗲 » `{name}`\n\n'
    ...
    #await m.reply_text("**🥳Abhi aaram ka time h🥳**")
    await m.reply_text(f"`✨𝗕𝗔𝗧𝗖𝗛 𝗦𝗨𝗠𝗠𝗔𝗥𝗬✨\n\n"
                       ...
                       f"▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n"
                       f"✅𝗦𝗧𝗔𝗧𝗨𝗦 » Phir milenge`")
    await m.reply_text(f"<pre><code>📥𝗘𝘅𝘁𝗿𝗮𝗰𝘁𝗲𝗱 𝗕𝘆 ➤『{AK}』</code></pre>")
    await m.reply_text(f"<pre><code>『😏Chill kro doston😏』</code></pre>")                 
